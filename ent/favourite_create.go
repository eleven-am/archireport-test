...
func (fc *FavouriteCreate) SetUserID(id int) *FavouriteCreate {
	fc.mutation.SetUserID(id)
	return fc
}

// SetUser sets the "user" edge to the User entity.
func (fc *FavouriteCreate) SetUser(u *User) *FavouriteCreate {
	return fc.SetUserID(u.ID)
}

// SetRoomID sets the "room" edge to the Room entity by ID.
func (fc *FavouriteCreate) SetRoomID(id int) *FavouriteCreate {
	fc.mutation.SetRoomID(id)
	return fc
}

// SetRoom sets the "room" edge to the Room entity.
func (fc *FavouriteCreate) SetRoom(r *Room) *FavouriteCreate {
...
func (fc *FavouriteCreate) check() error {
	...
	if _, ok := fc.mutation.RoomID(); !ok {
		return &ValidationError{Name: "room", err: errors.New(`ent: missing required edge "Favourite.room"`)}
	}
	return nil
}
