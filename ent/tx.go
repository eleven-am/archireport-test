...
func (tx *Tx) init() {
	...
	tx.CallParticipant = NewCallParticipantClient(tx.config)
	...
	tx.RoomMembership = NewRoomMembershipClient(tx.config)
...
// applies a query, for example: CallLog.QueryXXX(), the query will be executed
