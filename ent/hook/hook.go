...
// The CallParticipantFunc type is an adapter to allow the use of ordinary
// function as CallParticipant mutator.
type CallParticipantFunc func(context.Context, *ent.CallParticipantMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CallParticipantFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CallParticipantMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CallParticipantMutation", m)
}
...
// The RoomMembershipFunc type is an adapter to allow the use of ordinary
// function as RoomMembership mutator.
type RoomMembershipFunc func(context.Context, *ent.RoomMembershipMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RoomMembershipFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RoomMembershipMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RoomMembershipMutation", m)
}
